...
| `add-region`      | Not a sync skill: the playbook for a new region — one folder under `src/app/regions/`, its own strings and tests | §21           | — (on request; never scheduled by a sweep)                                      |
