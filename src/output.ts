...
// `console.*` calls. They fan out to the in-app log buffer (Settings →
// Developer renders it live) so a failure that happened on someone's phone
// is still readable on that phone.
